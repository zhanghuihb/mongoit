...
import com.mongoit.netty.constant.ConstantValue;
...
public class RequestDecoder extends ByteToMessageDecoder {
    ...
    @Override
    protected void decode(io.netty.channel.ChannelHandlerContext ctx, ByteBuf buffer, List<Object> out) throws Exception {
        while(true){
